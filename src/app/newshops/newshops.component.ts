...
@Component({
  selector: 'app-newshops',
  templateUrl: './newshops.component.html',
  styleUrls: ['./newshops.component.css'],
  providers: [AppGlobals]
})
export class NewshopsComponent implements OnInit {
  number: any;
  hubuserid: any;
  get: any;
  hubname: any;
  ...
  getnewshops(){
    var self = this;
    axios.get(`http://${this._global.baseUrl}:${this._global.port}/${this._global.version_no}/secure/newshops/profiles`)
        .then(function (res) {
